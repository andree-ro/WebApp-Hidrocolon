...
class Paciente {
    ...
    static async findAll(options = {}) {
        ...
        try {
            ...
            // ✅ FILTROS ESPECIALES CON FECHAS DINÁMICAS
            if (filtro === 'cumpleanos_mes') {
                ...
                console.log('🔍 Aplicando filtro citas_manana (dinámico con timezone GT)');
                ...
                console.log('🔍 Aplicando filtro sin_proxima_cita (dinámico con timezone GT)');
                ...
                console.log('🔍 Aplicando filtro citas_hoy (dinámico con timezone GT)');
    ...
    // GETSTATS - Estadísticas con fechas dinámicas
