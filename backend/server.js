...
const generalRateLimit = rateLimit({
    windowMs: 15 * 60 * 1000,
    max: NODE_ENV === 'development' ? 50000 : 1000,
    message: {
        success: false,
...
const apiRateLimit = rateLimit({
    windowMs: 1 * 60 * 1000,
    max: NODE_ENV === 'development' ? 50000 : 200,
    message: {
        success: false,
...
console.log('🏦 Rutas de depósitos cargadas');
...
app.listen(PORT, () => {
    ...
    console.log('📋 Módulos activos: auth, farmacia, extras, servicios, pacientes, ventas, turnos, comisiones, laboratorios, depósitos');
});
